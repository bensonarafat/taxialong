...
class BusStopSeeder extends Seeder
{
    ...
    public function run(): void
    {
        BusStop::factory()->createMany([
            ...
            ['latitude' => 8.96870, 'longitude' => 7.3536, 'name' => 'Conoil filling station'],
            ['latitude' => 8.96724, 'longitude' => 7.3519, 'name' => 'Conoil junction (River Park Estate junction)'],
            ...
            ['latitude' => 8.94152, 'longitude' => 7.2987, 'name' => 'Gosa market bridge'],

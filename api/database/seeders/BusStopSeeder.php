...
class BusStopSeeder extends Seeder
{
    ...
    public function run(): void
    {
        BusStop::factory()->createMany([
            ...
            ['latitude' => 8.9687007, 'longitude' => 7.3536672, 'name' => 'Conoil filling station'],
            ['latitude' => 8.9672400, 'longitude' => 7.3519242, 'name' => 'Conoil junction (River Park Estate junction)'],
            ...
            ['latitude' => 8.9415253, 'longitude' => 7.2987489, 'name' => 'Gosa market bridge'],
